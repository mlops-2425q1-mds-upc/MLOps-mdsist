"""
Tests for the mdsist.config module.
"""
...
def test_proj_root():
    ...
    ), "PROJ_ROOT should point to the correct project root."
...
def test_data_directories():
    ...
    ), "PROCESSED_DATA_DIR should be set correctly."
...
def test_environment_variable_loading():
    ...
    assert (
        os.getenv("SOME_ENV_VAR") == "test_value"
    ), "Environment variable should be loaded correctly."
...
def test_environment_variable_cleanup(setup_env):  # pylint: disable=W0613
